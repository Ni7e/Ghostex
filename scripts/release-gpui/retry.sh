...
#
# A failure is retried only when scripts/release-gpui/failure-classification.mjs
# recognizes it as transient. Unclassified output is fatal by design.
#
# Usage:
#   scripts/release-gpui/retry.sh <attempts> <base-delay-seconds> -- <command> [args...]
#   source scripts/release-gpui/retry.sh && release_gpui_retry 4 5 -- <command> [args...]
