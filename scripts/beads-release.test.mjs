...
describe("schema-compatible Beads release packaging", () => {
  test("pins the published schema-v54 artifacts and source identity for every release platform", () => {
    ...
    expect(BEADS_RELEASE_BASE_URL).toBe(
      "https://github.com/maddada/Ghostex/releases/download/v7.2.0",
    );
    ...
    expect(() => beadsReleaseArtifact("macos", "x86_64")).toThrow(
      /Unsupported Beads release platform/u,
    );
