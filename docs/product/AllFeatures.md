...
<!-- CDXC:Distribution 2026-06-28-09:00: The 5.0.0 public feature index must summarize Docs, Settings simplification, Source runtime reliability, GPUI progress, sidebar performance, app icons, Codex history search, and Homebrew warning cleanup without internal release mechanics. -->
...
- Ghostex-named agent skills install from the app and CLI: `$ghostex-browser-use`, `$ghostex-computer-use`, `$ghostex-agent-orchestration`, `$ghostex-generate-title`, `$ghostex-manage-beads`, and `$ghostex-move-codex-session`.
