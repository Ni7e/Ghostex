...
export const GPUI_CUSTOM_SESSION_TAGS_SERVER_SYNC_DELAY_MS = 400;
export const GPUI_CUSTOM_SESSION_TAGS_SERVER_SYNC_RETRY_DELAY_MS = 5000;
...
export const GPUI_SIDEBAR_WORKSPACE_TERMINAL_BELL_MESSAGE_TYPE =
...
export const GPUI_SIDEBAR_STASHED_PROMPT_SESSION_JUMP_MESSAGE_TYPE =
...
*/
export const GPUI_SIDEBAR_NOTIFICATION_FEED_COMMAND_EVENT_NAME =
  "ghostex-gpui-sidebar-notification-feed-command";
export const GPUI_SIDEBAR_NOTIFICATION_FEED_STATE_MESSAGE_TYPE =
...
export const GPUI_RENDERER_COMMAND_RENAME_TITLE_CONTROL_PATTERN =
  /[\u0000-\u001f\u007f-\u009f]/u;
...
export const GPUI_CLOSE_AFTER_DONE_STORAGE_KEY =
