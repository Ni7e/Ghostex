...
export function optionalNumberField<TKey extends string>(
  ...
  return value !== undefined
    ? ({ [key]: value } as Partial<Record<TKey, number>>)
    : {};
}
...
export function isGxserverRpcSuccess<TResult>(
  value: unknown,
  ...
  return (
    ...
    (value as Partial<GpuiGxserverRpcSuccess<TResult>>).product ===
      "gxserver" &&
    "result" in value
  );
}

export function gpuiGxserverRpcErrorMessage(
  value: unknown,
): string | undefined {
  /*
...
export function gpuiGxserverRpcErrorCode(
  value: unknown,
): GxserverRpcErrorCode | undefined {
  if (!value || typeof value !== "object" || Array.isArray(value)) {
    return undefined;
  }
  const record = value as Record<string, unknown>;
  return typeof record.error === "string"
    ? (record.error as GxserverRpcErrorCode)
    : undefined;
}
...
export function readGpuiRecordString(
  record: Record<string, unknown> | undefined,
  key: string,
): string | undefined {
  const value = record?.[key];
