...
/// A drag of the divider between the Agents column and the open view.
#[derive(Clone, Copy)]
pub(crate) struct WorkareaSplitResizeDragState {
...
pub(crate) fn split_resize_event_position(
    axis: WorkspaceSplitAxis,
