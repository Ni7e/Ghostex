        ...
        */
        ...
        let app = cx.new(move |cx| {
            let mut this = Self {
                ...
                parked_project_workarea_surfaces: Vec::new(),
                project_keep_alive_expiry_scheduled: false,
                ...
                remote_attach_requests: Default::default(),
                ...
                command_gpui_terminal_viewer_recipes: HashMap::new(),
