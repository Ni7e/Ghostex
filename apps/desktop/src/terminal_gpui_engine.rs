...
/// system install. Idempotent per process: the GPUI chat view registers the same
/// faces for its monospace text, and a host that opens both must not add them twice.
