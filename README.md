...
Latest download: [macOS Apple Silicon DMG](https://ghostex.dev/download/macos-arm64).
...
Latest downloads: [Windows x64](https://ghostex.dev/download/windows-x64) · [Windows ARM64](https://ghostex.dev/download/windows-arm64). Ghostex manages its terminals, gxserver, Source editor, and T3 Code runtime inside the selected WSL2 distribution.
...
Latest downloads: [Linux DEB](https://ghostex.dev/download/linux-deb-x64) · [Linux RPM](https://ghostex.dev/download/linux-rpm-x64).
