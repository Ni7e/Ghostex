...
pub(crate) const HOTKEY_DEFINITIONS: &[HotkeyDefinition] = &[
    ...
    HotkeyDefinition {
        ...
        default_key: "cmd+alt+t",
        windows_linux_default_key: None,
        retired_default_keys: &["cmd+shift+t"],
    ...
    HotkeyDefinition {
        ...
        description: "Open the project command terminal panel. When the pane is already focused, hide it; press again to show it.",
        default_key: "f12",
        windows_linux_default_key: None,
        retired_default_keys: &[],
    ...
    HotkeyDefinition {
        ...
        default_key: "cmd+n",
        windows_linux_default_key: None,
        retired_default_keys: &["ctrl+shift+b"],
    ...
    HotkeyDefinition {
        ...
        windows_linux_default_key: Some("cmd+alt+f"),
        retired_default_keys: &[],
        kind: "focusedPaneAction",
        icon: "git-fork",
    },
    HotkeyDefinition {
        ...
        windows_linux_default_key: Some("cmd+alt+r"),
        retired_default_keys: &[],
        kind: "focusedPaneAction",
        icon: "refresh",
    },
