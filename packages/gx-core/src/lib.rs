...
pub use crate::sidebar_view::{
    ...
    MachineSummary, OrderItem, OrderKind, ProjectContextView, ProjectDiffStats, SectionCollapse,
    SectionId, SectionView, SessionRow, SessionSortMode, SessionTiming, SessionView,
    ...
    OTHER_SPACE_ID, UNTAGGED_TAG_FILTER,
};
