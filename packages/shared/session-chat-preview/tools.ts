  ...
  return {
    ...
    messages: [
      ...
      previewRow('tools-8', 'assistant', 80, [
        ...
        previewCall('Grep', { pattern: 'sessionChatSimpleMode', path: 'packages/shared', output_mode: 'content' }),
        previewResult('packages/shared/session-chat-settings.ts:  sessionChatSimpleMode: false,'),
