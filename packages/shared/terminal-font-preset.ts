...
export const MESLO_TERMINAL_FONT_FAMILY = '"MesloLGL Nerd Font Mono", Menlo, Monaco, "Courier New", monospace';
...
export const DROID_SANS_MONO_TERMINAL_FONT_FAMILY = withBundledNerdFontFallback('"Droid Sans Mono", "monospace"');
export const LIBERATION_MONO_TERMINAL_FONT_FAMILY = withBundledNerdFontFallback('"Liberation Mono"');
export const DEJAVU_SANS_MONO_TERMINAL_FONT_FAMILY = withBundledNerdFontFallback('"DejaVu Sans Mono"');
...
export const SOURCE_CODE_PRO_TERMINAL_FONT_FAMILY = withBundledNerdFontFallback('"Source Code Pro"');
...
export function normalizeTerminalFontPreset(value: string | undefined): TerminalFontPreset {
  ...
  return TERMINAL_FONT_PRESET_BY_NORMALIZED_VALUE.get(normalizedValue) ?? DEFAULT_TERMINAL_FONT_PRESET;
}

export function getTerminalFontFamilyForPreset(preset: TerminalFontPreset): string {
  return (
    TERMINAL_FONT_PRESETS.find((candidate) => candidate.preset === preset)?.fontFamily ?? MONOSPACE_TERMINAL_FONT_FAMILY
  );
}
...
export function getTerminalFontPresetFromFontFamily(fontFamily: string | undefined): TerminalFontPreset {
