 ...
 * re-exports everything here and keeps the icon component mapping (that module
 * pulls React, so the decisions themselves live here where the native chat
 * runtime can reach them without it).
 *
