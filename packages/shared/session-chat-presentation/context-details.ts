...
export { formatSessionChatDuration } from '@/packages/core-ui/chat/session-chat-duration';
...
/** CDXC:SessionChatDetectedOptions 2026-09-17 DECISION:
 * User: GPUI and React share chat settings without a CEF service. Storage changes reach native consumers through the runtime broker and React consumers through this subscription.
 */
export function subscribeSessionChatContextDetailsPreferences(listener: () => void): () => void {
  const reread = () => {
