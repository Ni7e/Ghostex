import { clampNumber, isRecord, readLooseString } from './primitives';
...
export function normalizeSettingsModalNavigationState(candidate: unknown): SettingsModalNavigationState {
