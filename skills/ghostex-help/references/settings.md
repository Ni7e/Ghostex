...
- **Dark theme accent color** `accentColor` (text, default #86d3f8) [advanced]: Highlight color for accent text, status highlights, and advanced-setting markers in dark mode.
