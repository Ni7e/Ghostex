...
- **App theme** `sidebarTheme` (one of dark-2 | plain-light | system; default system): Follow the system appearance by default, or choose Light or Dark. Option labels: dark-2 = Dark, plain-light = Light, system = System.
...
- **Window glass** `windowGlass` (one of auto | frosted | opaque; default auto): Let the blurred desktop show through the window. Automatic uses glass in dark mode only. Option labels: auto = Automatic (glass in dark mode), frosted = Frosted glass, opaque = Opaque.
