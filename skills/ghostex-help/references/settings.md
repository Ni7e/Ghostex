...
- **App theme** `sidebarTheme` (one of dark-2 | plain-light | system; default system): Follow the system appearance by default, or choose Light or Dark Gray. Option labels: dark-2 = Dark Gray, plain-light = Light, system = System.
...
- **Dark theme background contrast** `customSidebarTitlebarBackgroundDarknessPercent` (number 85 to 100 default 96) [advanced]: Contrast level for the sidebar and window chrome background in dark mode. Light mode stays light gray.
- **Dark theme background tint** `customSidebarTitlebarBackgroundTintColor` (text, default #808080) [advanced]: Subtle tint color for the sidebar and window chrome background in dark mode. Light mode stays light gray.
...
- **Hide Dev Servers button** `devServersTitlebarButtonHidden` (boolean, default false): Hide Dev servers from the header ⋯ menu. The Browser view start page still lists them.
