...
- **App theme** `sidebarTheme` (one of dark-2 | plain-light | system; default dark-2): Light, Dark Gray, or follow the system appearance. Option labels: dark-2 = Dark Gray, plain-light = Light, system = System.
