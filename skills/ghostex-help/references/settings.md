...
- **Dark theme background contrast** `customSidebarTitlebarBackgroundDarknessPercent` (number 85 to 100 default 96) [advanced]: Contrast level for the sidebar and titlebar background in dark mode. Light mode stays light gray.
- **Dark theme background tint** `customSidebarTitlebarBackgroundTintColor` (text, default #808080) [advanced]: Subtle tint color for the sidebar and titlebar background in dark mode. Light mode stays light gray.
